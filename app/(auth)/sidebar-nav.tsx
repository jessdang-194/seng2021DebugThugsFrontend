```typescriptreact file="components/sidebar-nav.tsx"
...
import { BarChart3, FileText, Home, LogOut, Settings, Upload, User, History, Edit, Bell, Lock, HelpCircle, Mail } from 'lucide-react'
      ...
      <Sidebar className={cn("border-r", className)} {...props}>
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            {/* Submissions */}
            <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={isActive("/submissions") || isActive("/submission")}>
              ...
              <SidebarMenuSub>
                ...
                <SidebarMenuSubItem>
                  <SidebarMenuSubButton asChild isActive={isActive("/submissions")}>
                    <Link href="/submissions">
